...
calc_display = Entry(root, width=35, borderwidth=5)
calc_display.grid(row=0, column=0, columnspan=3, padx=10, pady=0)


# calc_display.insert(0, "Welcome to Calculator")
def button_click(number):
    current = calc_display.get()
    calc_display.delete(0, END)
    calc_display.insert(0, str(current) + str(number))
